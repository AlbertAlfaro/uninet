...
@section('title') Configuracion @endsection
@section('css')
    <!-- DataTables -->
        ...
        <div class="card">
            <div class="card-body">
				...
				<p class="card-title-desc">
					Usted se encuentra en el modulo Tecnicos.
				</p>
                ...
                <div class="table-responsive">
					...
					<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
						<thead>
							...
							<tbody>
								@foreach ($tecnicos as $obj_item)
								<tr class="filas">
									<td>{{$obj_item->id}}</td>
									<td>{{$obj_item->nombre}}</td>
									<td>{{$obj_item->direccion}}</td>
                                    ...
                                    <td>
                                        <div class="btn-group mr-1 mt-2">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('tecnicos.edit',$obj_item->id)}}">Editar</a>
        ...
        function eliminar(id){
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    window.location.href = "tecnicos/destroy/"+id;
